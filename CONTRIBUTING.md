...
Welcome to `pyscaffoldext-elegent-dsproject` contributor's guide.
...
If you experience bugs or general issues with `pyscaffoldext-elegent-dsproject`, please have a look
...
You can help improve `pyscaffoldext-elegent-dsproject` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pyscaffoldext-elegent-dsproject` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pyscaffoldext-elegent-dsproject`'s files. While this mechanism can
...
```
conda create -n pyscaffoldext-elegent-dsproject python=3 six virtualenv pytest pytest-cov
conda activate pyscaffoldext-elegent-dsproject
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pyscaffoldext-elegent-dsproject.git
...
5. Install [pre-commit]:
   ...
   `pyscaffoldext-elegent-dsproject` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pyscaffoldext-elegent-dsproject
[issue tracker]: https://github.com/<USERNAME>/pyscaffoldext-elegent-dsproject/issues
